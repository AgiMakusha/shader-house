  ...
  const getNotificationIcon = (type: string) => {
    ...
    switch (type) {
      ...
      case "BETA_ACCESS_GRANTED":
        return <FlaskConical className="w-8 h-8" style={iconStyle} />;
      case "FEEDBACK_RESPONSE":
        return <MessageCircle className="w-8 h-8" style={iconStyle} />;
      case "GAME_UPDATE":
        return <Gamepad2 className="w-8 h-8" style={iconStyle} />;
      case "ACHIEVEMENT_UNLOCKED":
        return <Trophy className="w-8 h-8" style={iconStyle} />;
        ...
        <div className="w-full max-w-4xl">
          ...
          {isLoading ? (
            ...
            >
              ...
              >
                You'll see notifications here when you receive beta access, achievements, and more!
              </p>
            </motion.div>
          ) : (
